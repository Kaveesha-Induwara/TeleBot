...
async def amireallyalive(alive):
    ...
    if ALV_PIC:
        ...
        tele += "    [✨ GitHub Repository ✨](https://github.com/imjanindu/TeleBot)"
        ...
        await alive.delete()
        return
    req = requests.get("https://telegra.ph/file/311ec92a7472564551c91.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            alive.chat_id,
            f"**Welcome To @ImJaniya's User Bot**\n\n"
            f"`{CUSTOM_ALIVE}`\n\n"
            f"{telemoji} **Telethon version**: `1.17`\n{telemoji} **Python**: `3.8.3`\n"
