...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "@Tech_Wizard_Ent"
...
async def amireallyalive(alive):
    ...
    if ALV_PIC:
        ...
        tele += "    [✨ GitHub Repository ✨](https://github.com/kaviya-admin/TeleBot)"
        ...
        await alive.delete()
        return
    req = requests.get("https://telegra.ph/file/e09fb70dc8b95dd6867ea.jpg")
